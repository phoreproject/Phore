...
BOOST_AUTO_TEST_CASE(rpc_rawparams)
{
    ...
    BOOST_CHECK_THROW(r = CallRPC(std::string("decoderawtransaction ")+rawtx+" extra"), runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC(std::string("signrawtransaction ")+rawtx+" null null badenum"), runtime_error);

    // Only check failure cases for sendrawtransaction, there's no network to send to...
    BOOST_CHECK_THROW(CallRPC("sendrawtransaction"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("sendrawtransaction null"), runtime_error);
    BOOST_CHECK_THROW(CallRPC("sendrawtransaction DEADBEEF"), runtime_error);
    BOOST_CHECK_THROW(CallRPC(std::string("sendrawtransaction ")+rawtx+" extra"), runtime_error);
}
...
BOOST_AUTO_TEST_CASE(rpc_ban)
{
    ...
    BOOST_CHECK_THROW(r = CallRPC(std::string("setban 127.0.0.0:8334")), runtime_error); //portnumber for setban not allowed
    ...
    BOOST_CHECK_THROW(r = CallRPC(std::string("setban 127.0.0.1 add")), runtime_error);
    ...
    BOOST_CHECK_THROW(r = CallRPC(std::string("setban 127.0.1.1 add")), runtime_error);
    ...
    BOOST_CHECK_THROW(r = CallRPC(std::string("setban test add")), runtime_error); //invalid IP
