...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_17_SEGWIT_ACTIVATION,              4070908800ULL), // OFF
    //MAKE_SPORK_DEF(SPORK_18_NEW_PROTOCOL_ENFORCEMENT_3,   4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_19_SEGWIT_ON_COINBASE,             4070908800ULL), // OFF
};
